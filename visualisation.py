...
def load_data():
    ...
    try:
        # Update file paths
        ratings_file = r"C:/Users/Lenovo/Desktop/Project/ml-1m/ml-1m/ratings.dat"  # Update the path as per your location
        movies_file = r"C:/Users/Lenovo/Desktop/Project/ml-1m/ml-1m/movies.dat"    # Update the path as per your location
        users_file = r"C:/Users/Lenovo/Desktop/Project/ml-1m/ml-1m/users.dat"      # Update the path as per your location
